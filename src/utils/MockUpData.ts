...
export const articlesData = [
  {
    ...
    author: "Winnie Hsu and Robert Brand",
    title:
    ...
    url: "https://finance.yahoo.com/news/asia-stocks-track-us-decline-225131752.html",
    urlToImage:
      "https://s.yimg.com/ny/api/res/1.2/8qy0wd_s.FADdpYCmFjsNg--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyMDA7aD00MjA-/https://media.zenfs.com/en/bloomberg_markets_842/c6b6d700dd358126be61d42243405ec2",
    publishedAt: "2024-02-21T08:25:37Z",
    content:
      "(Bloomberg) -- Europes stock benchmark retreated from near a record high amid disappointing earnings from some of the regions biggest companies.\r\nMost Read from Bloomberg\r\nThe Stoxx Europe 600 gauge … [+4911 chars]",
  },
  {
    source: {
      id: "axios",
